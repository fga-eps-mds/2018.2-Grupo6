...
#### 6.2 Restrições de Implementação
O sistema terá o *back-end* baseado em microsserviços desenvolvidos usando a linguagem Python com o *framework* Django e o *front-end* baseado em *JavaScript* com o *framework* *React-native*. O sistema deverá ser desenvolvido para funcionar junto a outros apps que serão desenvolvidos por outras equipes.
